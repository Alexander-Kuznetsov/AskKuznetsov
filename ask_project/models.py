...
class Profile(models.Model):
	avatar = models.ImageField(upload_to='avatars', null = True, blank = True, default='avatars/no-frame.png')
...
class QuestionManager(models.Manager):
	...
	def search_word(self, word):
		try:
			...
			#return self.filter(Q(title__icontains=word) | Q(text__icontains=word))
